...
<div class="panel panel-default">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><a href="<?php echo e(asset('public/img/'.$media->media_file)); ?>"><img src="<?php echo e(asset('public/img/'.$media->media_file)); ?>" class="img-responsive" style="max-width: 90px;"></a></td>
