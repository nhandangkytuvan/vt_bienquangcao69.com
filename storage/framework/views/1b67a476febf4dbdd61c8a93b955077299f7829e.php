    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group clearfix">
                ...
                <input type="text" class="form-control" name="post_name" value="<?php echo e($data['post']->post_name); ?>">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">Giá sản phẩm</label>
                        <input type="text" class="form-control" name="post_price" value="<?php echo e($data['post']->postSP ? $data['post']->postSP->post_price*100 : ''); ?>">
                    </div>
                </div>
            </div>
            <div class="row">
