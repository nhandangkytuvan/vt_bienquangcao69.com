                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <?php if($data['user']->user_avatar): ?>
                            <img src="<?php echo e(asset('public/img/'.$data['user']->user_avatar)); ?>" class="center-block img-circle" style="max-width: 80px;">
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="user_name" value="<?php echo e($data['user']->user_name); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" name="user_email" value="<?php echo e($data['user']->user_email); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <hr>
                    <form class="form-horizontal" action="<?php echo e(url('user/user/password')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
