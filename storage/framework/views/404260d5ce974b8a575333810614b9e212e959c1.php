    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control autosize" name="term_description"><?php echo e(old('term_description')); ?></textarea>
            </div>
            <div class="form-group">
                <label class="control-label">Keyword</label>
                <textarea type="text" class="form-control autosize" name="term_keyword"><?php echo e(old('term_keyword')); ?></textarea>
            </div>
            <div class="form-group">
                <label class="control-label">Meta</label>
                <textarea type="text" class="form-control autosize" name="term_meta"><?php echo e(old('term_meta')); ?></textarea>
            </div>
            <div class="form-group">
