    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="post_name" value="<?php echo e(old('post_name')); ?>">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">Giá sản phẩm</label>
                        <input type="text" class="form-control" name="post_price" value="<?php echo e(old('post_price')); ?>">
                    </div>
                </div>
            </div>
            <div class="row">
